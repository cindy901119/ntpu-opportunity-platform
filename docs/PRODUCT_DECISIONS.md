...
- 系所資料先以暫用正式名稱 mock catalog 承接；後續需整理北聯大各校正式系所架構。
- 學院 mapping 只供系統推導，不顯示在前台。
- 獎勵形式不再包含「獎學金」，因為獎學金已是機會類型。
- 「實體資源」與「曝光」先不放入第一版獎勵形式。
- 「高獎金」交由最高獎金範圍拉桿處理，不再作為其他條件。
- 「可累積作品集」因公告判斷不穩定，第一版先移除。
