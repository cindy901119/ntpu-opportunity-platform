...
const RECORDS = [
  {
    ...
    special_notes: ["本筆為年度公告，後續年度需確認當期收件期限。"],
  ...
  },
  {
    ...
    special_notes: ["申請日期為每年三月初，實際日期需確認系上公告。"],
    schedule: [],
    status: "needs_review",
  },
  {
    ...
    prize_text: "每學期若干名，每名10,000元。",
    max_prize_amount: 10000,
    summary: "統計系清寒獎學金，每學期開學後開放申請，需繳交申請表與前一學期成績單。",
    first_stage_deliverables: ["申請表", "成績單"],
    submission_types: ["申請表", "證明文件"],
    category_tags: ["系所獎學金", "清寒助學"],
    special_notes: ["實際申請日期需確認系上公告；頁面包含歷屆獲獎紀錄，匯入時只保留申請規則。"],
    schedule: [],
    status: "needs_review",
  },
  {
  ...
  },
  {
    ...
    prize_text: "每名每學期10,000至30,000元不等，名額1至數名。",
    ...
    category_tags: ["系所獎學金", "清寒助學"],
    special_notes: ["需於截止日前送交系辦；面談時間依系辦通知。"],
  ...
  },
  {
    ...
    special_notes: ["獲獎後需參加公開頒獎表揚，並繳交成績單與獎學金使用情況報告書。"],
  ...
  },
  {
    ...
    submission_types: ["申請表", "證明文件", "短文"],
    category_tags: ["系所獎學金", "清寒助學", "學業表現"],
    special_notes: ["本筆為年度公告，後續年度需確認當期收件期限；獲獎後需參加公開頒獎表揚。"],
  ...
  },
  {
    ...
    prize_text: "獎學金金額依法律學系研究生獎助學金施行細則與當期公告為準。",
